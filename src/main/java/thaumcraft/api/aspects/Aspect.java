...
public class Aspect {
	...
	public Aspect(String tag, int color, Aspect[] components) {
		this(tag,color,components,Identifier.fromNamespaceAndPath("thaumcraft","textures/aspects/"+tag.toLowerCase()+".png"),1);
	}
	...
	public Aspect(String tag, int color, Aspect[] components, int blend) {
		this(tag,color,components,Identifier.fromNamespaceAndPath("thaumcraft","textures/aspects/"+tag.toLowerCase()+".png"),blend);
	}
	...
	public String getLocalizedDescription() {
		return net.minecraft.network.chat.Component.translatable("tc.aspect."+tag).getString();
	}
