...
public class NodeSetting {
	...
	public String getValueText() {
		return net.minecraft.network.chat.Component.translatable(type.getValueText(value)).getString();
	}
	...
	public String getLocalizedName() {
		return net.minecraft.network.chat.Component.translatable(description).getString();
	}
