...
public class CardGlyphs extends TheorycraftCard
{
    ...
    public boolean activate(Player player, ResearchTableData data) {
        ...
        data.addTotal(s[player.getRandom().nextInt(s.length)], player.getRandom().nextIntBetweenInclusive(10, 20));
        data.addTotal("ELDRITCH", player.getRandom().nextIntBetweenInclusive(10, 20));
